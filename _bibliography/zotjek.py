...
collectionID = '4K4IEWK2' # Collection ID of 'Our publications'
...
for bib in zot_db:
    # Checks that the item is in the collection 'Our publications' with Collection ID '4K4IEWK2'
    if collectionID in bib['data']['collections']:
